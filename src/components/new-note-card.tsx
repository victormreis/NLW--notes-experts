          ...
          <form onSubmit={handleSaveNote} className="flex-1 flex flex-col">
            ...
            <div className="flex flex-1 flex-col gap-3 p-5 ">
              ...
              {shouldShowOnboarding ? (
                <p className="text-sm leading-6 text-slate-400">
                  Comece <button className="text-lime-400 hover:underline">gravando uma nota</button> em áudio ou se prefeir <button
            ...
            <button
              type="submit"
              className="w-full bg-lime-400 py-3 text-center text-sm text-lime-950 font-bold outline-none hover:bg-lime-500">
              Salvar nota
            </button>
          </form>
        </Dialog.Content>
