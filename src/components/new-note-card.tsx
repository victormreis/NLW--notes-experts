  ...
  return (
    <Dialog.Root open={shouldOpenModal} onOpenChange={setShouldOpenModal}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content onEscapeKeyDown={togleModal} onInteractOutside={togleModal} className='fixed overflow-hidden inset-0 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 max-h-[78vh] md:max-w-[640px] w-full md:h-[60vh] bg-slate-700 md:rounded-md flex flex-col outline-none '>
